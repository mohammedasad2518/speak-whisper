    ...
    <div className="flex-1 p-6 md:p-10">
      <div className="max-w-2xl space-y-8">
        <div className="animate-glass-in">
          <h1 className="text-2xl font-semibold tracking-tight text-foreground">New</h1>
        ...
        <div className="grid gap-4 sm:grid-cols-2 max-w-lg">
          <button
            ...
            className="glass-card glass-hover flex flex-col items-start gap-3 p-6 text-left animate-glass-in"
          ...
          >
            ...
            <div>
              <p className="text-base font-semibold text-foreground">Text to Speech</p>
          ...
          >
            ...
            <div>
              <p className="text-base font-semibold text-foreground">Speech to Text</p>
